...
load_bemap <- function() {
  ...
  # 4) Max Ownership -----------------------------------------------------------
  # The Sub-Manager shall not cause the Sub-Account to acquire or hold in excess
  # of 4.99% of the outstanding equity securities of a class which is registered
  # pursuant to Section 12 of the Exchange Act.  To the extent the foregoing
  # restriction is breached due to a decrease in the number of outstanding
  # shares of the issuer, the Sub-Manager will promptly bring the Sub-Account
  # into compliance with such restriction.
  ...
  # Commodity Interests --------------------------------------------------------
  # The Sub-Manager shall not trade any commodity interests (as defined under
  # the Commodity Exchange Act) for the Sub-Account without the prior written
  ...
  # 13) Net Exposure Limit -----------------------------------------------------
  # The Sub-Manager shall ensure that the Net Exposure of the Sub-Account is not
  # greater than 50% or less than –50% of the Sub-Account NAV.
  bemap$add_rule(.sma_rule(
    sma_name = "bemap",
  ...
  # The Sub-Manager shall not cause the Sub-Account to make any investments into
  # spot/physical virtual currency or virtual currency derivatives
  ...
  # 15) China Outbound Investment Restrictioon ---------------------------------
